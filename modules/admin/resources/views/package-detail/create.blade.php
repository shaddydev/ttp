      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-rose card-header-icon">
            ...
            <h4 class="card-title">Add New Package Rule for <b>{{$package->title}}</b></h4>
          </div>
          <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <div class="form-group {{ $errors->has('commission') ? 'has-error' : '' }}">
                              <input type="text" required class="form-control" name="commission" placeholder="Enter Commission">
