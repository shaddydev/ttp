               ...
               <div class="card-body">
                  <div class="account-details">
                     ...
                     <div class="account-details">
                        ...
                        <div align = "right">
                           <a id="myBtn2" href = "{{url(Auth::user()->role->name.'/downloadPDF/'.Request::segment(4).'/'.Request::segment(5))}}" class = "btn btn-danger">Download Invoice</a>
                        </div>
                        <div class="row" >
                           <div class="col-md-12">
                              <div class="card">
                                       ...
                                       <div class="col-sm-6">
                                         ...
                                         @foreach($bookingslist as $data)
                                          ...
                                          <div class="panel panel-primary">
                                                <?php //echo "<pre>";print_r($bookingslist[0]['booking_details'][0]);exit;?>
                                              @foreach($bookingslist[0]['booking_details'] as $bookingdetails)
                                                   ...
                                                   @foreach($bookingslist as $data)
                                                     ...
                                                     @foreach($decode as $bookdata)
                                                      <tr> 
                                                         ...
                                                         <td>{{date('j-M-Y H:i:s',strtotime($bookdata->Origin->DepTime))}}</td>
                                                         ...
                                                         <td valign="top" style="padding-top: 20px;">
                                                            <table cellpadding="0" cellspacing="0" border="1" style="width:100%;  border-color: #f9f9f9;">
                                                               <tbody>
                                                                  ...
                                                                  <tr>
                                                                     <td style=" border-bottom: 1px solid #f1f1f1; padding:10px;">Baggage</td>
                                                                     <td style=" border-bottom: 1px solid #f1f1f1; padding:10px;">₹ {{$baggageCharge}}</td>
                                                                  </tr>
