   ...
   <div class="row no-gutters">
                  ...
                  <div class="airlines">
                     ...
                     <div class="all-airlines" ng-if="searchResponse === 1 && hasError === 0 " >
                        <div ng-repeat="(key, flight) in flights.Response.Results[0] | unique:'Segments[0][0].Airline.AirlineName' "  class="custom-control custom-checkbox" >
                           <div class="d-flex">
                              <input type="checkbox" data-ng-change="filterFlights('AirlineCode')" value="@{{flight.Segments[0][0].Airline.AirlineCode}}"  data-ng-model='Filter.AirlineCode[flight.Segments[0][0].Airline.AirlineCode]' class="airline-check custom-control-input" id="flight_@{{key}}">
      ...
      <img ng-if="searchResponse === 0" class="no-data" src="/public/images/no-data.png">
         <div ng-if="flights.Response.Error.ErrorCode === 0" >
               ...
               <div class="d-flex justify-content-between">
                  ...
                  <div class="right-div d-flex align-items-center">
                     ...
                     @if( !Auth::guest() && Auth::user()->hasRole('agent'))
                        ...
                        <div class="custom-control custom-checkbox custom-control-inline ml-2 mr-0">
                           <input type = "checkbox" class = "custom-control-input showdatacomission" id="agentCheck">
                           <label for="agentCheck" class="custom-control-label"></label>
                        </div>
            ...
            <div class="flight-head internalFlight">
               ...
               <div class="flight-rest">
                  <div class="internalRest">
                     <div class="internalRestinner">
                        <div title="Sort by Departure" ng-click="setOrderProperty('Segments[0][0].StopPointDepartureTime')" class="flight-depart">Departure</div>
                        <div title="Sort by Arrival" ng-click="setOrderProperty('Segments[0][0].StopPointArrivalTime')" class="flight-ariv">Arrival</div>
            ...
            <div class="flight-body internalFlight" >
               <div ng-repeat="(key, flight) in flights.Response.Results[0] | orderBy:orderProperty | filter: filterFunction"  class="flight-body-main" >
                  <div class="flight-inner">
                     <div class="flight-Btitle" >
                        ...
                        <div class="flightX">
                           <div ng-repeat="(keyes, values1) in flight.Segments">
                              <p class="flight-name" >@{{flight.Segments[keyes][0].Airline.AirlineName}}</p>
                              <p class="flight-price1">@{{flight.Segments[keyes][0].Airline.AirlineCode}} @{{flight.Segments[keyes][0].Airline.FlightNumber}} (@{{flight.Segments[keyes][0].Airline.FareClass}})</p>
                           </div>
                        </div>
                     </div>
                     <div class="flight-rest">
                        <div class="internalRest" >
                           <div class="internalRestinner" ng-repeat="(index, value) in flight.Segments">
                              <div>
                                 <div ng-repeat="(index25, value25) in value" > 

                                 <div class="flight-Bdepart" > @{{value25.Origin.Airport.AirportCode}}<strong>(@{{value25.Origin.DepTime.substr(11,5)}})</strong></div> <img src="/public/images/long-arrow.png">

                                 <div  class="flight-Bariv" > @{{value25.Destination.Airport.AirportCode}}<strong>(@{{value25.Destination.ArrTime.substr(11,5)}})</strong></div>
                              ...
                              <p ng-if="flight.Segments[0].length === 1" >@{{ timeFormatText(flight.Segments[index][0].Duration)}}</p>
                              <p ng-if="flight.Segments[0].length > 1" >@{{ timeFormatText(flight.Segments[index][flight.Segments[index].length-1].AccumulatedDuration - flight.Segments[index][flight.Segments[0].length-1].GroundTime )}}</p>
                                 <?php $value="{{flight.Segments[index][0].Airline.AirlineCode}}";?>
                                 <img src="/public/images/long-arrow.png">
                                 <p ng-if="flight.Segments[index].length === 1" >Non-stop</p>
                                 <p ng-if="flight.Segments[index].length > 1" >@{{flight.Segments[index].length-1}} stop</p>
                              </div>
                           </div>
                          
                        </div>
                        <div class="flight-Bbtn">
                           <div data-toggle="tooltip" data-trigger="click" data-html="true" title="" class="flight-Bprice new">
                              <div class = "internationprice"><strong>@{{priceDisplay(flight.Fare.PublishedFare+service_charge+service_charge_gst)}}</strong></div>
                              ...
                              <div class = "showflightcommision" style = "display:none">
                              <div class="commission-area" ng-repeat="(cid, commission) in package_commission" >
                  ...
                  <div class="flight-footer">
                     <div class="flight-details"><a href="#" data-toggle="modal" data-resultindex = "@{{flight.ResultIndex}}" class = "farequotes"  data-target="#flightDetail_@{{key}}" >Flight Detail</a></div>
                  </div>
                  <div class="modal fade" id="flightDetail_@{{key}}" role="dialog" style="display: none;" aria-hidden="true">
                     <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                           ...
                           <div class="modal-body" >
                              <div class="modal-top" ng-repeat="(index, value) in flight.Segments">
                                 
                                 
                              </div>
                              <div class="modal-tabs" ng-repeat="(index, value) in flight.Segments">
                              <div class="center-div" ng-if="index == 0">
                              <ul>
                                 <li>
                              ...
                              <div class="center-div" ng-if="index == 1">
                                    ...
                                    <span class="schedule">@{{dateFormattext(postData.date_down)}} | 
                                      <duration ng-if="flight.Segments[0].length === 1" >@{{ timeFormatText(flight.Segments[1][0].Duration)}}</duration>
                                      <duration ng-if="flight.Segments[0].length > 1" >@{{ timeFormatText(flight.Segments[1][flight.Segments[0].length-1].AccumulatedDuration - flight.Segments[1][flight.Segments[0].length-1].GroundTime )}}
                                      </duration>  | 
                                    <span class="non-stop" ng-if="flight.Segments[0].length === 1" >Non-stop</span>
                                    <span class="non-stop" ng-if="flight.Segments[1].length > 1" >@{{flight.Segments[1].length-1}} stop</span>
                                    </span>
                              </div>
                                 <ul class="nav nav-tabs">
                                    <li><a data-toggle="tab" href="#basic_@{{key}}@{{index}}" class="active">Itinerary</a></li>
                                    <li><a data-toggle="tab" href="#detailed_@{{key}}@{{index}}">Fare SUMMARY & RuleS </a></li>
                                 </ul>
                                 <div class="tab-content">

                                    <div id="basic_@{{key}}@{{index}}" class="tab-pane fade in active">
                                       <div ng-repeat="(seg_key, segment) in flight.Segments[index]" class="sector-detail">
                                          <div class="row">
                                    ...
                                    <div id="detailed_@{{key}}@{{index}}" class="tab-pane fade">
                                       <!-- <div class="row">
                                          <div class="col-md-6"> -->
							  ...
							  <div class="right-div internationalModal">
