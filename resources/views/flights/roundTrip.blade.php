                  ...
                  <div class="full-fiter">
                     ...
                     <div class="airlines">
                        ...
                        <div class="all-airlines" ng-if="searchResponse === 1 && hasError === 0 " >
                           <div ng-repeat="(key, flight) in flights.Response.Results[0] | unique:'Segments[0][0].Airline.AirlineName' "  class="custom-control custom-checkbox newlook" >
                              <div class="d-flex">
                                 <input type="checkbox" name = "checkbox" data-ng-change="filterFlights('AirlineCode')" value="@{{flight.Segments[0][0].Airline.AirlineCode}}"  data-ng-model='Filter.AirlineCode[flight.Segments[0][0].Airline.AirlineCode]' class="custom-control-input untrigged" id="flightss_@{{key}}">
                                 <label class="custom-control-label" for="flightss_@{{key}}">
                                    <div class="d-flex">
         ...
         <img ng-if="searchResponse === 0" class="no-data" src="/public/images/no-data.png">
            <div ng-if="flights.Response.Error.ErrorCode === 0" >
               <div class="top-section">
                  <div class="d-flex justify-content-between">
                     <div class="left-div">
                        <p>Found @{{flights.Response.Results[0].length+flights.Response.Results[1].length}} Flights</p>
                        ...
                        <div class="modal-body">
                           <form action="{{url('flights')}}" method="get">
                                 ...
                                 <div class="col-md-12">
                                    <div class="trip-radio" id = "trip">
                                       <div class="custom-control custom-radio">
                                          <input type="radio" class="custom-control-input" id="oneway" name="triptype" value = "oneway">
                                          <label class="custom-control-label" for="oneway">One Way</label>
                                       </div>
                                       <div class="custom-control custom-radio">
                                          <input type="radio" class="custom-control-input" id="roundtrip" name="triptype" checked value = "roundtrip">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-3 form-group">
                                    <input type="text" name = "end" placeholder="enter destination" class="airport_list_down form-control" id="destination" value="{{$postData['end']}}">
            ...
            <div class="flight-list">
				...
				<div class="airline-section"> 
                  ...
                  <div class="flight-per-adult">
                     <p>All Airlines</p>
                  </div>
                  <div class="airline-slider">
                     <div class="airlineSlide">
                        <div class="owl-carousel" id="airlineSlider">

                           <div class="airlineItem" ng-repeat="(key, flight) in flights.Response.Results[0] | unique: 'Segments[0][0].Airline.AirlineName' ">
                           
                              <a href = "javaScript:void(0);" class = "getcheckbox">
                              <input type="hidden" name = "flightid" value = "flightss_@{{key}}">
                              <div class="airlineImg"><img src="/public/images/airlines/@{{flight.Segments[0][0].Airline.AirlineCode}}.gif"></div>
                              <div class="airlineContent">
                                 <p class="airline-name" >@{{flight.Segments[0][0].Airline.AirlineName}}</p>
                                 <p>@{{priceDisplay(flight.Fare.PublishedFare+service_charge+service_charge_gst)}} </p>
                              </div>
                              </a>
                           </div>
            ...
            @if(isset($_GET['specialreturn']))
               <a href = "{{url(url()->full().'&specialreturn=')}}" class="bttn active" name = "extraLcc" value="2">Normal Return </a>
            
            @endif
           
            @if(isset($_GET['specialreturn']) && !empty($_GET['specialreturn']) && $_GET['specialreturn'] == 5)
            <a href = "{{url(url()->full())}}" class="bttn" name = "extraLcc" value="5">LCC Return </a>
          
            @else
            <a href = "{{url(url()->full().'&specialreturn=5')}}" class="bttn" name = "extraLcc" value="5">LCC Return </a>
            @endif            
            </div>
				 	      <div class="airline-listing">
                           <div class="airline-from" >
                                 ...
                                 <div class="d-flex justify-content-between">
                                    <div class="left-div">
                                       <ul>
                                          <li> 
                                             <p>{{$postData['origin']}}</p>
                                             <p><small id = "start_date">{{$postData['date_up']}}</small></p>
                                             <i class="fas fa-long-arrow-alt-right"></i>
                                          </li>
                                          <li>
                                             <p>{{$postData['destination']}}</p>
                                          </li>
                                       </ul>
                                    </div>
                                    <div class="right-div">
                                       <a href="#" class="next-date" id = "nextdate">Next Date <i class="fas fa-caret-right"></i></a>
                                       <a href="javascript:void(0);" id="chooseDateBtn" class="prodDetBtngreen activegreen"><i class="far fa-calendar-alt"></i></a>
                                       <input type ="hidden" class="dateHidden" value="date" />
                                       <div class="choosedatepicker">
                              ...
                              <div  title="Sort by Airline" ng-click="sortColumn('Segments[0][0].Airline.AirlineName')" class="flight-title">Airline</div>
                               
                                    <div  title="Sort by Departure" ng-click="sortColumn('Segments[0][0].Origin.DepTime')" class="flight-title">Departure</div>
                                    <div title="Sort by Arrival" ng-click="sortColumn('Segments[0][0].Destination.ArrTime')" class="flight-ariv">Arrival</div>
                                    <div title="Sort by Duration" ng-click="sortColumn('Segments[0][0].Duration')" class="flight-dur">Duration</div>
                                    <div title="Sort by Price" ng-click="sortColumn('Fare.PublishedFare')" class="flight-price">Price</div>
                                    
                                
                              </div>
                              <div class="flight-body" >
                              <div ng-repeat="(key, flight) in flights.Response.Results[0] | orderBy:orderProperty | filter: filterFunction | orderBy:column:reverse"  class="flight-body-main" >
                                    <div class="custom-control custom-radio">
                                    <input type="radio"  id="customRadio@{{key}}" name="airlinefrom" class="custom-control-input getlist">
                                          ...
                                          <div class="flight-inner">
                                             <div class="flight-Btitle">
                                                ...
                                                <div>
                                                   ...
                                                   <p class="flight-price1">@{{flight.Segments[0][0].Airline.AirlineCode}} @{{flight.Segments[0][0].Airline.FlightNumber}} (@{{flight.Segments[0][0].Airline.FareClass}})</p>
                                                </div>
                                             </div>
                                             ...
                                             <input type="hidden" class="flight-Bprice-hidden" value="@{{priceDisplay(flight.Fare.PublishedFare+service_charge+service_charge_gst)}}" >

                                             <div data-toggle="tooltip" data-trigger="click" data-html="true" title="" class="flight-Bprice">@{{priceDisplay(flight.Fare.PublishedFare+service_charge+service_charge_gst)}}
                                             ...
                                             <div class="tooltip-content" >
                                                ...
                                                <table class="table table-condensed" width="100%" cellspacing="0" cellpadding="0" style="position:relative;">
                                                      ...
                                                      <tbody>
                                                         ...
                                                         <tr style="display:none" class="commission-area"  ng-repeat="(cid, commission) in package_commission" >
                                                            <td colspan="@{{flight.FareBreakdown.length}}" >
                                                            <table class="commission-tooltip" ng-if="commission.code == flight.Segments[0][0].Airline.AirlineCode" >
                                                               <tr ng-if="commission.fare_type == 2 " >
                                                                  <td colspan="@{{flight.FareBreakdown.length}}" >Commission :</td>
                                                                  <td colspan="@{{flight.FareBreakdown.length}}" >
                                                                  @{{ priceDisplay( ( (flight.Fare.BaseFare +  flight.Fare.YQTax) * commission.commission /100) - (((flight.Fare.BaseFare +  flight.Fare.YQTax) * commission.commission /100)*18/100 )  )  }}</td>
                                                               </tr>
                                                               <tr ng-if="commission.fare_type == 2 "  >
                                                                  <td colspan="@{{flight.FareBreakdown.length}}" >Payable Amount :</td>
                                                                  <td colspan="@{{flight.FareBreakdown.length}}" >
                                                                  @{{ priceDisplay( flight.Fare.PublishedFare+service_charge+service_charge_gst - ( (flight.Fare.BaseFare +  flight.Fare.YQTax) * commission.commission /100) - (((flight.Fare.BaseFare +  flight.Fare.YQTax) * commission.commission /100) *18/100 ) )  }}
                                                                  </td>
                                                               </tr>
                                                               ...
                                                               <td>Commission :</td>
                                                                  <td colspan="@{{flight.FareBreakdown.length}}" >
                                                                  @{{ priceDisplay(  ( (flight.Fare.BaseFare) * commission.commission /100)- (((flight.Fare.BaseFare) * commission.commission /100)*18/100) ) }}</td>
                                                               </tr>
                                                               <tr ng-if="commission.fare_type == 1 " >
                                                               <td colspan="@{{flight.FareBreakdown.length}}" >Payable Amount :</td>
                                                                  <td colspan="@{{flight.FareBreakdown.length}}" >
                                                                  @{{ priceDisplay(flight.Fare.PublishedFare+service_charge+service_charge_gst -  ( ((flight.Fare.BaseFare) * commission.commission /100)-((flight.Fare.BaseFare) * commission.commission /100)*18/100) ) }}</td>
                                                               </tr>
                                                            </table>
                                                         <td>
                                                      </tr>
                                             ...
                                             <div style="display:none" class="commission-area" ng-repeat="(cid, commission) in package_commission" >
                                                  ...
                                                  <span ng-if="commission.code == flight.Segments[0][0].Airline.AirlineCode" >
                                                    <span ng-if="commission.fare_type == 2 " >
                                                      @{{ priceDisplay(((flight.Fare.BaseFare +  flight.Fare.YQTax) * commission.commission /100) - ((flight.Fare.BaseFare +  flight.Fare.YQTax) * commission.commission /100) *18/100)  }} | 
                                               
                                                      @{{ priceDisplay(flight.Fare.PublishedFare+service_charge+service_charge_gst - ( (flight.Fare.BaseFare +  flight.Fare.YQTax) * commission.commission /100) - ((flight.Fare.BaseFare +  flight.Fare.YQTax) * commission.commission /100) *18/100) }} 
                                               
                                                    </span>
                                                    <span ng-if="commission.fare_type == 1 " >
                                                      @{{ priceDisplay( ((flight.Fare.BaseFare) * commission.commission /100)-((flight.Fare.BaseFare) * commission.commission /100)*18/100 ) }} |
                                               
                                                      @{{ priceDisplay(flight.Fare.PublishedFare+service_charge+service_charge_gst -  ( ((flight.Fare.BaseFare) * commission.commission /100)-((flight.Fare.BaseFare) * commission.commission /100)*18/100) ) }}  
                                                    </span>
                                                  </span>
                                               </div>
                                       ...
                                       <input type = "hidden" value = "@{{flight.ResultIndex}}">
                                    </div>
                                      
                                    <div class="flight-footer">
                                       <div class="float-right"><a href="#" >@{{remarkDisplay(flight.AirlineRemark)}}</a></div>
                                       <div class="flight-details float-left"><a href="#" data-toggle="modal" data-resultindex = "@{{flight.ResultIndex}}" class = "farequotes" data-target="#rflightDetail_@{{key}}" >Flight Detail</a></div>
                                    </div>
                                 ...
                                 <div class="d-flex justify-content-between">
                                    <div class="left-div">
                                       <ul>
                                          <li>
                                             <p>{{$postData['destination']}}</p>
                                             <p> <small id="preview_date">{{$postData['date_down']}}</small></p>
                                             <i class="fas fa-long-arrow-alt-right"></i>
                                          </li>
                                          <li>
                                             <p>{{$postData['origin']}}</p>
                                    ...
                                    <div class="right-div">
                                       <a href="#" class="previous-date" id = "previous"><i class="fas fa-caret-left" ></i> Prev Date</a><a href="#" class="next-date" id = "next1">Next Date <i class="fas fa-caret-right"></i></a>
                                       <a href="javascript:void(0);" id="chooseDateBtn1" class="prodDetBtngreen activegreen"><i class="far fa-calendar-alt"></i></a>
                                       <input type ="hidden" class="dateHidden" value="date" />
                                       <div class="choosedatepicker">
                                          <div id="datepicker1" style="display:none;"></div>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="flight-head">
                                 <div class="flight-title" ng-click="sortType = 'Segments[0][0].Airline.AirlineName'; sortReverse = !sortReverse">Airline</div>
                                 <div class="flight-depart" ng-click="sortType = 'Segments[0][0].Origin.DepTime'; sortReverse = !sortReverse">Departure</div>
                                 <div class="flight-ariv" ng-click="sortType = 'Segments[0][0].Destination.ArrTime'; sortReverse = !sortReverse">Arrival</div>
                                 <div class="flight-dur" ng-click="sortType = 'Segments[0][0].Duration'; sortReverse = !sortReverse">Duration</div>
                                 <div class="flight-price" ng-click="sortType = 'Fare.PublishedFare'; sortReverse = !sortReverse">Price</div>
                              </div>
                              <div class="flight-body">
                                 <div ng-repeat="(key, flight) in flights.Response.Results[1] | orderBy:orderProperty | filter: filterFunction | orderBy:sortType:sortReverse"  class="flight-body-main" >
                                    <div class="custom-control custom-radio">
                                       <input type="radio" id="customRadio48@{{key}}" name="airlineto" class="custom-control-input returnlist">
                                       <label class="custom-control-label" for="customRadio48@{{key}}">
                                          <div class="flight-inner">
                                             <div class="flight-Btitle">
                                                <div class="flight-logo">
                                                   <img src="/public/images/airlines/@{{flight.Segments[0][0].Airline.AirlineCode}}.gif">
                                             ...
                                             <div class="flight-Bprice">@{{priceDisplay(flight.Fare.PublishedFare+service_charge+service_charge_gst)}}
                                        ...
                                        <input type = "hidden" value = "@{{flight.ResultIndex}}">
                                        <input type = "hidden" value = "@{{flights.Response.TraceId}}">
                                    </div>
                                    <div class="flight-footer">
                                       <div class="float-right"><a href="#" >@{{remarkDisplay(flight.AirlineRemark)}}</a></div>
                                       <div class="flight-details float-left"><a href="#" data-resultindex = "@{{flight.ResultIndex}}" class = "farequotes" data-toggle="modal" data-target="#rflightDetail_@{{key}}" >Flight Detail</a></div>
                                    </div>

                                    <div class="modal fade" id="rflightDetail_@{{key}}" role="dialog" style="display: none;" aria-hidden="true">
                     <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                           <div class="modal-header">
                              <h4 class="modal-title">Flight Details</h4>
                           ...
                           <div class="modal-body">
                              <div class="modal-top">
                                 <div class="center-div">
                                    ...
                                    <span class="schedule">@{{dateFormattext(postData.date_down)}} | 
                                    <duration ng-if="flight.Segments[0].length === 1" >@{{ timeFormatText(flight.Segments[0][0].Duration)}}</duration>
                                    <duration ng-if="flight.Segments[0].length > 1" >@{{ timeFormatText(flight.Segments[0][flight.Segments[0].length-1].AccumulatedDuration - flight.Segments[0][flight.Segments[0].length-1].GroundTime )}}
                                    </duration> | 
                                    <span class="non-stop" ng-if="flight.Segments[0].length === 1" >Non-stop</span>
                              ...
                              <div class="modal-tabs">
                                 <ul class="nav nav-tabs">
                                    <li><a data-toggle="tab" href="#rbasic_@{{key}}" class="active">Itinerary</a></li>
                                    <li><a data-toggle="tab" href="#rdetailed_@{{key}}">Fare SUMMARY & RuleS </a></li>
                                 </ul>
                                 <div class="tab-content">
                                    <div id="rbasic_@{{key}}" class="tab-pane fade in active">
                                       <div ng-repeat="(seg_key, segment) in flight.Segments[0]" class="sector-detail">
                                          <div class="row">
                                             <div class="text-sm-center col-sm-2 col-lg-3 text-xs-left">
                                                <div class="flight-pic">
                                    ...
                                    <div id="rdetailed_@{{key}}" class="tab-pane fade">
                                       <!-- <div class="row">
                                          <div class="col-md-6"> -->
                                             <div class="one-fourth">
                                                <div class="insert-content">
...
<section  id="footer-border" >
            <div class="roundbook">
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="roundbook-fixed">
                           <div class="roundbook-innerm">
                              <div class="roundbook-inner ones" style = "display:none">
                              <p id = "flightname" style = "color:#fff;">@{{flight.Segments[0][0].Airline.AirlineName}}</p>
                                 <div class="round-logo" ><img src="assets/images/flight-logo.jpg" id = "flightlogo"></div>
                                 <div class="round-rest">
                                   
                                    <div class="round-depart" id = "depart">
                                       06.10 
                                       <div class="long-arrow"><i class="fas fa-long-arrow-alt-right"></i></div>
                                    </div>
                                    <div class="round-ariv" id = "arrive">08.20</div>
                                    <div class="round-dur">
                                       <p id = "duration">0h 45m <small>Non-stop</small> </p>
                                    </div>
                                 </div>
                              </div>
                              <div class="roundbook-inner two" style = "display:none">
                              <p id = "rflightname" style = "color:#fff;"></p>
                                 <div class="round-logo">
                                    <img src="assets/images/flight-logo.jpg" id = "rflightlogo">
                                 </div>
                                 <div class="round-rest">
                                    <div class="round-depart" id = "rdepart">
                                       06.10 
                                       <div class="long-arrow"><i class="fas fa-long-arrow-alt-right"></i></div>
                                    </div>
                                    <div class="round-ariv" id = "rarrive">08.20</div>
                                    <div class="round-dur">
                                       <p id = "rduration">0h 45m <small>Non-stop</small></p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div class="roundbook-inner1">
                              <div class="round-total">
                                 <p>Total Fare</p>
                                 <p class="round-amt"><i class="fas fa-rupee-sign"></i> <span id = "totalprice">17,600 <span></p>
                              </div>
                              <div class="round-btn">
                              <a href="javascript:void(0);"  id = "booknow" >Book Now</a>
                              </div>
                           </div>
                        </div>
                     </div>
